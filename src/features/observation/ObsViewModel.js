    ...
    <div>
      <div className={`modal ${id ? "modal-open" : ""}`}>
        <div className="modal-box">
          <h3 className="heading">Observation</h3>
          ...
          <div class="grid grid-cols-2 gap-0">
            ...
            <div>
              <span className="field-label">Observation Date & Time</span>
            </div>
